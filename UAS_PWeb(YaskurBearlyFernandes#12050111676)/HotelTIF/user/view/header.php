...
<html>
<head>
	<title>Sistem Informasi Pemesanan Kamar Pada Hotel TIF</title>
	<meta charset="utf-8">
...
<body>
	<nav>
			<img src="../gambar/logo.png" width="100px"> <span style="float: right; margin-right: 80px;"><center><img src="../simpangambar/<?php 
				if ($foto != '') {
					echo $foto;
				}
				else {
